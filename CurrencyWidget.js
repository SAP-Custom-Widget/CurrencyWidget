...
this._props._amountprice = getprice;
this.setAmount(getprice);
//console.log(this._props.price);
      }
...
//console.log(this._props);
  // this._props["amountprice"] = this._props["_amountprice"];
  //changedProperties["amountprice"] = "superman";

}

setAmount(price){
  const amountprice = price;
